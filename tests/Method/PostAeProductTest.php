...
HTML;
        ...
        // Product Unit (storage unit number)
        $product_units = [
            100000000 => 'bags (bag / bags)',
            100000001 => 'keg (barrel / barrels)',
            100000002 => 'bushels (bushel / bushels)',
            100078580 => 'box (carton)',
            100078581 => 'cm (centimeter)',
            100000003 => 'cubic meters (cubic meter )',
            100000004 => 'playing (dozen)',
            100078584 => 'ft (feet)',
            100000005 => 'gal (gallon)',
            100000006 => 'g (gram)',
            100078587 => 'inch (inch)',
            100000007 => 'kg (kilogram)',
            100078589 => 'one thousand liters (kiloliter)',
            100000008 => 'one thousand meters (kilometer )',
            100078559 => 'L (liter / liters)',
            100000009 => 'British tons (long ton)',
            100000010 => 'm (meter)',
            100000011 => 'tonne (metric ton)',
            100078560 => 'mg (milligram)',
            100078596 => 'ml (milliliter)',
            100078597 => 'mm (millimeter)',
            100000012 => 'oz (ounce)',
            100000014 => 'package (pack / packs)',
            100000013 => 'double (pair)',
            100000015 => 'pieces / month (piece / pieces)',
            100000016 => 'lb (pound)',
            100078603 => 'quart (quart)',
            100000017 => 'set (set / sets)',
            100000018 => 'US ton (short ton)',
            100078606 => 'sqft (square feet)',
            100078607 => 'square inches (square inch)',
            100000019 => 'square meter (square meter)',
            100078609 => 'square yard (square yard)',
            100000020 => 'tonne (ton)',
            100078558 => 'Code (yard / yards)'
        ];
